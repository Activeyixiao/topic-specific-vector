...
if __name__ == '__main__':
    ...
    train_obj = read_concepts('/home/yixiao/NLP/KEL/evaluation_data/McRae_new/MC-train.txt')
    print(len(train_obj))
    test_obj = read_concepts('/home/yixiao/NLP/KEL/evaluation_data/McRae_new/MC-test.txt')
    print(len(test_obj))
    ...
    for key in D_fea_words.keys():
        ...
        t_pos = [w for w in pos if w in train_obj]
        test_pos = [w for w in pos if w in test_obj]
        train_pos,valid_pos = train_test_split(t_pos,random_state=2021,test_size=0.25)
        t_neg = [w for w in neg if w in train_obj]
        test_neg = [w for w in neg if w in test_obj]
